...
public class BasicAuthClient {
   ...
   public static void main(String args[]) {
    ...
    try {
		...
		if(args == null)
		{
			System.out.println("Usage: java wroxaxis.chapter5.BasicAuthClient <username> <password>");
			System.exit(0);
		}
		...
		String endpointURL = "http://localhost:8080/axis/services/protected/SparePartPrice";
