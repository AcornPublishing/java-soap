...
public class SOAPResponseLogger extends BasicHandler {
    ...
    public void invoke(org.apache.axis.MessageContext messageContext) throws org.apache.axis.AxisFault {
        try {
            ...
            //Retrieve the startTime from the messageContext "StartTime" property that was
            //set by the SOAPRequestLogger
            ...
            float duration = ((float)(currentTimeMills - startTimeMills))/1000;
            ...
            if ((logfilename == null) || (logfilename.equals(""))) {
                throw new AxisFault("Server.NoLogFileConfigured",
                                     "The logfilename parameter option for AccessLogHandler was not set",
                                    null,null);
			}
